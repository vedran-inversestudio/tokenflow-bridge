...
// Create a more robust token extraction function
...
console.log('✅ Enhanced token extraction function installed successfully!');
console.log('The plugin will now extract tokens directly from the raw data structure.'); 